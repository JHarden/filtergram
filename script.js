...
window.onload = function(){
    ...
    function download() {
        this.href = canvas.toDataURL();//this may not work in the future..
    }
...
function handleImage(e){
    ...
    var ub = document.getElementById("img_capture");
    ub.className = ub.className + " active";
    var co = document.getElementById("canvas_outer");
    co.className = co.className + " canvas-paper";
